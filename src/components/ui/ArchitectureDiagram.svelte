  ...
  <div>
    ...
    <div class="relative min-h-[32rem] sm:min-h-[36rem] lg:min-h-[40rem] overflow-hidden">
      ...
      {#each layers as layer (layer.idx)}
        ...
        >
          <div
            class="w-[22rem] max-w-[30%] h-full px-4 py-4 sm:px-6 sm:py-6 backdrop-blur-[2px] {layer.fill} flex flex-col gap-3"
          >
      ...
      >
        <div
          class="w-[22rem] max-w-[30%] h-full px-4 py-4 sm:px-6 sm:py-6 backdrop-blur-[6px] flex flex-col gap-2 overflow-hidden"
