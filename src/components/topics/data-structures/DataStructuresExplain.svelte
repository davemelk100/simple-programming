...
<div class="space-y-8">
  ...
  <!-- Array section -->
  <div class="transition-all duration-700 {showArray ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}">
    <h3 class="mb-3 text-center text-lg font-bold text-green-700">Arrays: Ordered Lists</h3>
    <p class="mb-4 text-center text-sm text-slate-600">An array is a numbered list of items. Each item has an <strong>index</strong> (its position number, starting from 0).</p>
  ...
  <!-- Object section -->
  <div class="transition-all duration-700 {showObject ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}">
    <h3 class="mb-3 text-center text-lg font-bold text-green-700">Objects: Labeled Containers</h3>
    <p class="mb-4 text-center text-sm text-slate-600">An object stores data with <strong>labels</strong> (called keys) instead of numbers.</p>

    <div class="mx-auto max-w-xs rounded-xl border-2 border-green-400 bg-green-50 p-4 shadow-md">
